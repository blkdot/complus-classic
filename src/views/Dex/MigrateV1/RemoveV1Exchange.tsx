...
import { JSBI, Token, TokenAmount, WAVAX, Fraction, Percent, CurrencyAmount } from '@complus/sdk-ava'
...
import { isAddress } from '../../../utils/dexUtils'
    ...
    exchangeContract
      ...
      .then((response: TransactionResponse) => {
        ...
        addTransaction(response, {
          summary: `Remove ${chainId && token.equals(WAVAX[chainId]) ? 'WAVAX' : token.symbol}/AVAX V1 liquidity`
        })
  ...
  return (
    <AutoColumn gap="20px">
      ...
      <TYPE.darkGray style={{ textAlign: 'center' }}>
        {`Your Complus V1 ${
          chainId && token.equals(WAVAX[chainId]) ? 'WAVAX' : token.symbol
        }/AVAX liquidity will be redeemed for underlying assets.`}
      </TYPE.darkGray>
    </AutoColumn>
  )
}
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text="Remove your Complus V1 liquidity tokens." />
          </div>
        </AutoRow>
