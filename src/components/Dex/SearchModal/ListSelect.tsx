...
import { CloseIcon, ExternalLink, LinkStyledButton, TYPE } from '../../../theme/dexTheme'
    ...
    <Row key={listUrl} align="center" padding="16px" id={listUrlRowHTMLId(listUrl)}>
      ...
      {isSelected ? (
        <ButtonPrimary
          ...
          style={{ width: '5rem', minWidth: '5rem', padding: '0.5rem .35rem', borderRadius: '0.5rem', fontSize: '14px' }}
        >
          {t('selected')}
        </ButtonPrimary>
      ) : (
  ...
  return (
    <Column style={{ width: '100%', flex: '1 1' }}>
      ...
      <PaddedColumn gap="14px">
        <Text fontWeight={600}>
          Add a list{' '}
          <QuestionHelper text="Token lists are an open specification for lists of ARC20 tokens. You can use any token list by entering its URL below. Beware that third party token lists can contain fake or malicious ARC20 tokens." />
        </Text>
        <Row>
          <SearchInput
            type="text"
            ...
            style={{ height: '2.75rem', borderRadius: '0.5rem', padding: '12px' }}
          />
      ...
      <div style={{ padding: '16px', textAlign: 'center' }}>
        <ExternalLink href="https://github.com/complusnetwork/default-token-list">{t('browseList')}</ExternalLink>
      </div>
    </Column>
  )
}
