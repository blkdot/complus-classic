    ...
    if (step === 'disclaimer') {
      return (
        <StyledDiv>
          ...
          <p>
            The Yield Farming and Staking contracts has been deployed and verified on Avalanche C-Chain.
          </p>
          <p>
            <StyledLink target="_blank" href="https://snowtrace.io/address/0xa329D806fbC80a14415588334ae4b205813C6BB2#code">Our Farming Contract</StyledLink>
          </p>
          <hr/>
          <p>
            <img src={approval} height="60" alt="Approval" /><br/>COM distribution will start from block number <b>203619</b>.
          </p>
          <p>
            COM distribution will be <u>10x</u> on the first day (60 COM per block). After block number <b>232419</b>, distribution will be (6 COM) per a block for the first year on the Avalanche C-Chain.
          </p>
        </StyledDiv>
      )
    } else {
      return (
        <StyledDiv>
          ...
          <p>Airdrop owner address:<br/>
            <StyledLink target="_blank" href="https://snowtrace.io/address/0x5dB72a2fB612838E879d452033a685143eA3593f/token-transfers">
              0x5dB72a2fB612838E879d452033a685143eA3593f
            </StyledLink>
          </p>
          <hr/>
          <p>
            1.404.000 COM minted to the team allocation address. Payments will be made monthly. Team will receive 39.000 COM.
          </p>
          <p>Team allocation address:<br/>
            <StyledLink target="_blank" href="https://snowtrace.io/address/0x1533eefEf4a35b28458472bF21fC84d66e94C69E/token-transfers">
