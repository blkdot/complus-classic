...
export class Complus {
  constructor(provider, networkId, testing, options) {
    ...
    this.complusAddress = contractAddresses.complus[networkId]
    this.sudoSuAddress = contractAddresses.sudoSu[networkId]
    this.wavaxAddress = contractAddresses.wavax[networkId]
  }
